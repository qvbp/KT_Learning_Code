...
class BertEmbedding:
    def __init__(self, device='cuda'):
        ...
        self.model = BertModel.from_pretrained('./bge-large-en-v1.5').to(device)
        self.model.eval()
...
if __name__ == "__main__":
    ...
    # 加载JSON文件
    json_file_path = './data/kcs_context_nips_task34.json'  # 替换为你的JSON文件路径
    ...
    # 保存embeddings到文件
    output_file = './data/kc_embeddings_nips_task34_bge.npy'
