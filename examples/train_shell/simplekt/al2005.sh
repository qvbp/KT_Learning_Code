...
d_ff=(256 256 64 256 256)
nheads=(4 4 4 4 4)
dropouts=(0.1 0.05 0.1 0.1 0.1)
loss2=(0.5 0.5 0.5 0.5 0.5)
final_fc_dim2=(256 256 64 256 256)
loss1=(0.5 0.5 0.5 0.5 0.5)
d_model=(128 128 128 128 128)
num_attn_heads=(4 4 4 4 4)
num_layers=(2 2 2 2 2)
seeds=(42 42 3407 42 3407)
final_fc_dim=(256 256 256 256 256)
n_blocks=(4 4 4 4 4)
start=(50 50 50 50 50)
learning_rate=(0.0001 0.0001 0.0001 0.0001 0.00001)
...
for fold in {0..4}; do
    CUDA_VISIBLE_DEVICES=$fold python ./wandb_simplekt_train.py \
        ...
        > ./train_log/simplekt/simplekt_change_algebra2005_${fold}_train.txt &
done
